...
const About: React.FC = () => {
  ...
  return (
    <div className="pt-[100px] sm:pt-[40px] xs:pt-[40px] pb-[20px] bg-[#ffffff] xl:px-[120px] lg:px-[80px] md:px-[40px] sm:px-10 xs:px-10 px-[20px] 2xl:h-screen">
      <div className="flex xl:flex-row lg:flex-row md:flex-col sm:flex-col xs:flex-col 2xs:flex-col items-center justify-center gap-[40px]">
        ...
        <div className="relative w-full 2xs:w-[320px] xs:w-[375px] sm:w-[425px] md:px-10 sm:px-10 xs:px-10 2xs:px-5 md:w-[700px] lg:w-[800px] h-[220px] xs:h-[280px] sm:h-[320px] md:h-[420px] lg:h-[520px]">
      ...
      {/* Stats Section */}
      <div className="flex  justify-center  mt-[40px] mb-[20px] xs:mx-10 ">
