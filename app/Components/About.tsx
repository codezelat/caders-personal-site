...
<div className="relative w-full 2xs:w-[320px] xs:w-[375px] sm:w-[425px] md:w-[700px] lg:w-[800px] h-[220px] xs:h-[280px] sm:h-[320px] md:h-[420px] lg:h-[520px]">
  ...
  <div className="relative w-full h-full rounded-[16px] md:rounded-[24px] lg:rounded-[32px] border-[4px] md:border-[6px] lg:border-[8px] border-[#03045E] overflow-hidden">
    {galleryImages.map((src, index) => (
      ...
      {/* Stats Section */}
      <div className="flex font-poppins justify-center mt-[30px] mb-[20px]">
